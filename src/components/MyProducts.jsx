        ...
        <div className="col-md-6">
            <div className="card shadow-lg p-3 mb-5 bg-white rounded">
                <div className="card-body">
                    ...
                    >
                        <i class="fab fa-android"></i> Web App
                     </a>
                    ...
                    >
                        <i class="fas fa-globe-asia"></i> Mobile App
                     </a>
                                ...
                                <div class="modal-content">
                                 ...
                                 <button  type="button" class="close" data-dismiss="modal">&times;</button>
                                    ...
                                    <div class="modal-body" style={{padding:0}}>
                                        <Iframe
                                        src= {id==0 ? "https://drive.google.com/file/d/1q9j7R5TDIbnScH3mds00y7a4D79ON7T0/preview" : "https://drive.google.com/file/d/1kCXIGOOA5uK1Sz8whLecL_L0BPugXR3l/preview" }
                                           width="100%"
                                            height="700px"
                                            id="myId"
                                            />
